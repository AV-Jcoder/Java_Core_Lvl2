package org.example.part_5_OOPrinciple.lesson26hard;
 ...
 *
 * Для каждого не абстрактного класса переопределить метод toString() класса для представления
 * информации о классах в строковой форме
 *
