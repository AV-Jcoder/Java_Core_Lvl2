...
/**
 * Задача 2
 * Создать статический обобщённый метод swap в утилитном
 * классе PairUtil (утилитный класс – это класс только со статическими методами,
...
public class Tasks {
    ...
    public static void main(String[] args) {
        ...
        Pair<Integer, String> pair2 = PairUtil.Swap(pair);
